...
\begin{document}
    ...
    \section{Education}
        ...
        \vspace{0.10 cm}
            ...
            \textbf{PUCPR}, Pós Graduação Arquitetura de Software, Ciência de Dados e Cybersecurity\end{twocolentry}
            \item GPA: 7/10 (\href{https://posdigital.pucpr.br/cursos/ciencia-de-dados-arquitetura-de-software-e-cybersecurity?utm_medium=cpc&utm_source=Google&utm_campaign=PUCPR_PRF_CONV_SEARCH_POS-GRAD_Always-On_BR_ARQUITETURA-SOFT&utm_group=C_666_CONV_SEARCH_POS-GRAD_Always-On_ARQUITETURA-SOFTWARE&utm_term=curso%2520arquitetura%2520de%2520software&gad_source=1&gclid=Cj0KCQjw1Yy5BhD-ARIsAI0RbXYqtw8DOk155wRfgvRrFsSBoB6VkKH5eZ0aN7E5y-8Yxa6wetpGkyMaAox2EALw_wcB})
                \item \textbf{Coursework:} LGPD: do Privacity by Design ao Sistema Legado, Jornada DevOps: Como Implantar Projetos com Alta Qualidade, Mitigando Atritos Entre Times Utilizando DevSecOps, Padrões Arquiteturais: Como Tornar seu Projeto Escalável e Confiável, Cybersecurity: Conhecendo as Vulnerabilidades da Aplicação, Projetando Arquitetura com Segurança: um Framework para proteger o Ciclo de Vida do Software, Migração Para Ambiente em Cloud, Vale a Pena? Evitando a Estratégia de Lift And Shift, Escalando Negócios com Arquitetura Multi-Cloud: Prepare-se Para Esse Futuro Agora!, Arquitetura de Microsserviços e Microcontainer: o Negócio como Serviço, Serverless Computing: Como Coordenar Componentes e Serviços Distribuídos, Arquitetura Big Data: Como potencializar as Análises e Tomada de Decisões Ágeis, Ciência de Dados: Agile Data Science Escalável, Soft Skills para Negociação e Tomada de Decisão, Ética: Inteligência Moral na Era Digital, Admirável Futuro Novo
            \end{highlights}
        \end{onecolentry}
